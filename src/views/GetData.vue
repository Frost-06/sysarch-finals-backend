<template>
  <div id="app">
    <header>
     ...
     <br>
        <br>    
        <h1 v-bind:key="customer.username">{{customer.id}}</h1>
        <br>
        <table border = "1px" id = "users">
            ...
            <tr v-for="customer in list" v-bind:key="customer.id">
                ...
                <td>{{customer.username}}</td>
                  ...
                  <td>{{customer.stats}}</td>
                <td><button class = "btnEdit" @click="openModel(customer)" type="showModal"><i class="fa fa-shopping-cart fa_custom fa-1x" data-toggle="modal" data-target="#form"></i>Edit</button></td>
                <td><button class = "btnEdit" @click="openModel1(customer)" type="showModal"><i class="fa fa-shopping-cart fa_custom fa-1x" data-toggle="modal" data-target="#form"></i>Transaction</button></td>
            </tr>
        </table>
                             ...
                             <div class = "modal-content">
                                 ...
                                 <div class = "modal-body">
                                     ...
                                     <div class = "form-group">
                                         ...
                                         <input type = "time" class = "form-control" v-model="transactions.startTime" />
                                     </div>
                                     <div class = "form-group">
                                         <label>End Time</label>
                                         <input type = "time" class = "form-control" v-model="transactions.endTime"/>
                                     </div>
                                     <div class = "form-group">
                                         <label>Bike Type</label>                         
                                         <select class = "form-control"  v-model="transactions.bikeType">
                                           <option>MOUNTAINBIKE</option>
                                           <option>ROADBIKE</option>
                                           <option>ELECTRICBIKE</option>
                                         </select>
                                     </div>
                                     <div class = "form-group">
                                         <label>Qty</label>
                                         <input type = "text" class = "form-control" v-model="transactions.qty"/>
                                     </div>
                                     <br />
                                     <div align = "center">  
                                         <input type="button" class="btn btn-primary" v-model="actionButton" @click="saveTransaction()" />
                                     </div>
                                 </div>
                             </div>
                         </div>
